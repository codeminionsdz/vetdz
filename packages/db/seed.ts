...
async function seed() {
  ...
  const [practice] = await db
    .insert(practices)
    .values({
      name: "Clinique Vétérinaire d'Alger",
      address: "11 Rue Didouche Mourad, Alger",
      phone: "+213 21 00 00 01",
      email: "contact@clinique-alger.vetdz.dz",
      website: "https://vetdz.dz",
      timezone: "Africa/Algiers",
      settings: { locale: "fr", currency: "DZD", country: "Algeria" },
  ...
  const usersData = [
    ...
    },
    {
      ...
      name: "Dr. Yacine Benyahia",
      role: "veterinarian" as const,
      licenseNumber: "VET-DZ-00123",
      phone: "+213 21 00 00 12",
    },
    {
      email: "amel.boussouf@clinique-alger.vetdz.dz",
      name: "Dr. Amel Boussouf",
      role: "veterinarian" as const,
      licenseNumber: "VET-DZ-00456",
      phone: "+213 21 00 00 13",
    },
    {
      email: "sara.bennani@clinique-alger.vetdz.dz",
      name: "Dr. Sara Bennani",
      role: "veterinarian" as const,
      licenseNumber: "VET-DZ-00789",
      phone: "+213 21 00 00 14",
    },
    {
      ...
      licenseNumber: null,
      phone: "+213 21 00 00 15",
    },
    {
      email: "nadia.meddour@clinique-alger.vetdz.dz",
      name: "Nadia Meddour",
      role: "technician" as const,
      licenseNumber: null,
      phone: "+213 21 00 00 16",
    },
    {
      ...
      licenseNumber: null,
      phone: "+213 21 00 00 17",
    },
    {
      email: "leila.rahmani@clinique-alger.vetdz.dz",
      name: "Leïla Rahmani",
      role: "front_desk" as const,
      licenseNumber: null,
      phone: "+213 21 00 00 18",
    },
  ];
  ...
  // =========================================================================
  const clientsData = [
    { firstName: "Mohamed", lastName: "Cherif", address: "12 Rue Hassiba Benbouali", city: "Alger", state: "Alger", zip: "16000", phone: "+213 660 111 001", email: "mohamed.cherif@example.dz" },
    { firstName: "Yasmine", lastName: "Bensaid", address: "3 Rue Didouche Mourad", city: "Alger", state: "Alger", zip: "16000", phone: "+213 660 111 002", email: "yasmine.bensaid@example.dz" },
    { firstName: "Karim", lastName: "Bekkouche", address: "8 Rue Mohamed Belouizdad", city: "Alger", state: "Alger", zip: "16000", phone: "+213 660 111 003", email: "karim.bekkouche@example.dz" },
    { firstName: "Leila", lastName: "Ait Ahmed", address: "25 Avenue Pasteur", city: "Oran", state: "Oran", zip: "31000", phone: "+213 660 111 004", email: "leila.aitahmed@example.dz" },
    { firstName: "Amine", lastName: "Belkacem", address: "44 Rue Boushaki", city: "Constantine", state: "Constantine", zip: "25000", phone: "+213 660 111 005", email: "amine.belkacem@example.dz" },
    { firstName: "Nour", lastName: "Mansouri", address: "18 Rue Sidi M'hamed", city: "Alger", state: "Alger", zip: "16000", phone: "+213 660 111 006", email: "nour.mansouri@example.dz" },
    { firstName: "Rachid", lastName: "Khelifi", address: "7 Avenue Ferhat Abbas", city: "Oran", state: "Oran", zip: "31000", phone: "+213 660 111 007", email: "rachid.khelifi@example.dz" },
    { firstName: "Sara", lastName: "Bouzid", address: "29 Rue Didouche Mourad", city: "Alger", state: "Alger", zip: "16000", phone: "+213 660 111 008", email: "sara.bouzid@example.dz" },
    { firstName: "Walid", lastName: "Mahdjoub", address: "52 Rue Larbi Ben M'hidi", city: "Constantine", state: "Constantine", zip: "25000", phone: "+213 660 111 009", email: "walid.mahdjoub@example.dz" },
    { firstName: "Lina", lastName: "Daoud", address: "5 Rue Hassiba Benbouali", city: "Annaba", state: "Annaba", zip: "23000", phone: "+213 660 111 010", email: "lina.daoud@example.dz" },
    { firstName: "Fares", lastName: "Benaissa", address: "13 Rue Ahmed Zabana", city: "Sétif", state: "Sétif", zip: "19000", phone: "+213 660 111 011", email: "fares.benaissa@example.dz" },
    { firstName: "Imane", lastName: "Trabelsi", address: "33 Rue Didouche Mourad", city: "Bejaia", state: "Béjaïa", zip: "06000", phone: "+213 660 111 012", email: "imane.trabelsi@example.dz" },
    { firstName: "Karim", lastName: "Zitouni", address: "21 Boulevard Zighout Youcef", city: "Oran", state: "Oran", zip: "31000", phone: "+213 660 111 013", email: "karim.zitouni@example.dz" },
    { firstName: "Nadia", lastName: "Chergui", address: "17 Rue Emir Abdelkader", city: "Tlemcen", state: "Tlemcen", zip: "13000", phone: "+213 660 111 014", email: "nadia.chergui@example.dz" },
    { firstName: "Yacine", lastName: "Bensalah", address: "9 Rue du 1er Novembre", city: "Blida", state: "Blida", zip: "09000", phone: "+213 660 111 015", email: "yacine.bensalah@example.dz" },
    { firstName: "Amina", lastName: "Bensalem", address: "27 Rue du 1er Mai", city: "Sidi Bel Abbès", state: "Sidi Bel Abbès", zip: "22000", phone: "+213 660 111 016", email: "amina.bensalem@example.dz" },
    { firstName: "Ismail", lastName: "Taski", address: "6 Rue Emir Abdelkader", city: "Oran", state: "Oran", zip: "31000", phone: "+213 660 111 017", email: "ismail.taski@example.dz" },
    { firstName: "Meriem", lastName: "Ould Ali", address: "41 Rue Abane Ramdane", city: "Annaba", state: "Annaba", zip: "23000", phone: "+213 660 111 018", email: "meriem.ouldali@example.dz" },
    { firstName: "Nabil", lastName: "Gherbi", address: "30 Rue Larbi Ben M'hidi", city: "Constantine", state: "Constantine", zip: "25000", phone: "+213 660 111 019", email: "nabil.gherbi@example.dz" },
    { firstName: "Soumia", lastName: "Kherfi", address: "11 Avenue Moulay Youcef", city: "Biskra", state: "Biskra", zip: "07000", phone: "+213 660 111 020", email: "soumia.kherfi@example.dz" },
    { firstName: "Omar", lastName: "Belkhadem", address: "19 Rue Didouche Mourad", city: "Skikda", state: "Skikda", zip: "21000", phone: "+213 660 111 021", email: "omar.belkhadem@example.dz" },
    { firstName: "Nesrine", lastName: "Guendouz", address: "14 Rue Mostefa Ben Boulaid", city: "Batna", state: "Batna", zip: "05000", phone: "+213 660 111 022", email: "nesrine.guendouz@example.dz" },
    { firstName: "Amar", lastName: "Fekrane", address: "25 Rue Sidi M'hamed", city: "Djelfa", state: "Djelfa", zip: "17000", phone: "+213 660 111 023", email: "amar.fekrane@example.dz" },
    { firstName: "Leila", lastName: "Boudiaf", address: "34 Rue de la Liberté", city: "Tizi Ouzou", state: "Tizi Ouzou", zip: "15000", phone: "+213 660 111 024", email: "leila.boudiaf@example.dz" },
    { firstName: "Rania", lastName: "Azzouz", address: "12 Rue Yasmina Khadra", city: "Setif", state: "Sétif", zip: "19000", phone: "+213 660 111 025", email: "rania.azzouz@example.dz" },
  ];
  ...
  const patientsData: {
    clientIdx: number;
    name: string;
    species: "canine" | "feline" | "avian" | "rabbit" | "reptile" | "sheep" | "goat" | "cow" | "horse" | "camel";
    breed: string;
    ...
    // Livestock examples (Algerian practice)
    { clientIdx: 0, name: "Mouton Azzouz", species: "sheep", breed: "Ouled Djellal", sex: "male", dob: "2019-03-01", color: "Blanc", weightKg: "70.0" },
    { clientIdx: 1, name: "Chèvre Kahina", species: "goat", breed: "Kabyle", sex: "female", dob: "2020-06-15", color: "Brun", weightKg: "35.0" },
    { clientIdx: 2, name: "Vache Zahra", species: "cow", breed: "Blonde d'Aquitaine", sex: "female", dob: "2017-09-10", color: "Fauve", weightKg: "450.0" },
    { clientIdx: 3, name: "Cheval Amir", species: "horse", breed: "Barbe", sex: "male", dob: "2015-04-20", color: "Noir", weightKg: "480.0" },
    { clientIdx: 4, name: "Dromadaire Salem", species: "camel", breed: "Chameau Sahara", sex: "male", dob: "2014-11-02", color: "Sable", weightKg: "600.0" },
  ];

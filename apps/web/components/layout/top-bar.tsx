...
const NEW_ACTIONS = [
  ...
  { label: "Nouveau patient", href: "/patients/new", Icon: PawPrint },
  { label: "Nouveau rendez-vous", href: "/schedule", Icon: Calendar },
  { label: "Nouvelle facture", href: "/billing/new", Icon: Receipt },
];
...
export function TopBar({
  ...
  const label = routeLabels[basePath] ?? "VetDZ";

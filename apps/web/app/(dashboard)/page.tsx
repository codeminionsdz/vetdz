...
const kpiConfig = [
  ...
  },
  {
    ...
    description: "Sorties aujourd'hui",
    icon: PawPrint,
    format: (v: number) => String(v),
  },
  {
    key: "revenueMtd" as const,
    label: "Revenus (Mois à ce jour)",
    description: "Factures payées ce mois-ci",
    icon: DollarSign,
  ...
  },
  {
    ...
    description: "Envoyées ou en retard",
    icon: FileText,
    format: (v: number) => String(v),
  },
];
  ...
  return (
    <div className="space-y-8">
      ...
      {charts.isLoading ? (
        ...
        <>
          <div className="grid gap-4 md:grid-cols-2">
            {/* Rendez-vous cette semaine - Bar Chart */}

...
export const metadata: Metadata = {
  title: "VetDZ API Reference",
  description: "API documentation for VetDZ veterinary practice management",
};
  ...
  return (
    <div className="flex min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <nav className="sticky top-0 hidden h-screen w-64 shrink-0 overflow-y-auto border-r border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900 lg:block">
        <div className="mb-6">
          <h2 className="text-lg font-bold text-teal-600 dark:text-teal-400">VetDZ API</h2>
      ...
      <main className="flex-1 px-6 py-10 lg:px-12">
        <div className="mx-auto max-w-4xl">
          {/* Header */}
          <div className="mb-12">
            <h1 className="text-3xl font-bold text-slate-900 dark:text-white">VetDZ API Reference</h1>
            <p className="mt-3 text-lg text-slate-600 dark:text-slate-400">
              Complete API documentation for the VetDZ veterinary practice
  ...
  return crypto.timingSafeEqual(
    ...
    Buffer.from("sha256=" + expected)
          ...
          <footer className="mt-16 border-t border-slate-200 pt-6 text-center text-sm text-slate-500 dark:border-slate-700">
            <p>VetDZ &mdash; Open-source veterinary practice management.</p>
            <p className="mt-1">

...
const SYSTEM_PROMPT = `You are the Assistant VetDZ, an operations assistant embedded in an open-source veterinary practice management system.
...
export class AgentNotConfiguredError extends Error {
  constructor() {
    super(
      "Assistant VetDZ n'est pas configuré. Définissez ANTHROPIC_API_KEY pour activer l'agent."
    );
...
/**
 * Run the Assistant VetDZ agent against a natural-language instruction. Executes a
